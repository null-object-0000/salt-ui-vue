<template>
  ...
  <div class="content">
    ...
    <salt-rounded-column title="Edit 组件">
      <salt-item-edit v-model="model.text" hint="HINT 这是输入框"></salt-item-edit>
      <salt-item-edit-password v-model="model.password" hint="HINT 这是密码输入框"></salt-item-edit-password>
    </salt-rounded-column>
  ...
  <div class="footer">
    <salt-bottom-bar>
      <salt-bottom-bar-item :state="true" painter="qr-code" text="二维码"></salt-bottom-bar-item>
      <salt-bottom-bar-item :state="false" painter="verified" text="认证"></salt-bottom-bar-item>
    </salt-bottom-bar>
  </div>
</template>
